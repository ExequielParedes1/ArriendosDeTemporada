<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADMVer_reporte_3.aspx.cs" Inherits="WEBArriendoTemporada.ADMVer_reporte_3" %>
        ...
        <div>
            ...
            <asp:Panel runat="server" ID="DescargarPDF">
                <div class="container">
                    ...
                    <div>
                        <p class="text-center">
                            <h1>Ganancias Mensuales
                                <asp:Label runat="server" ID="lblAño"></asp:Label>
                            </h1>
                        </p>
                        <h2>
                    ...
                    <p>
                        <asp:Label runat="server" ID="segundaZonaArriendo">
                        </asp:Label><asp:Label runat="server" ID="cantidadSegundaZona"></asp:Label>
                    </p>
                    ...
                    <br />
                    <h2>Ganancias por Departamento</h2>
                    <br />
                    ...
                    <asp:GridView ID="GridView1" CssClass="table" runat="server" AutoGenerateColumns="false">
                        <Columns>
                            ...
                            <asp:BoundField DataField="_departamento_id_departamento" HeaderText="Departamento Asociado" SortExpression="_departamento_id_departamentos"></asp:BoundField>
                        </Columns>
                    </asp:GridView>
                </div>
            </asp:Panel>
